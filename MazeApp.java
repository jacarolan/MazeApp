...
public class MazeApp extends JFrame implements ActionListener {
    ...
    public MazeApp() {
        ...
        visButton = new JButton("Visualize");

        // places to put all the top menu items
        JPanel buttons1 = new JPanel(new GridLayout(1, 4));  // top row of buttons
        JPanel buttons2 = new JPanel(new GridLayout(1, 4));  // bottom row of buttons
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == visButton) {
            if (mazeLoaded) {
                if(solver.isSolved()) {
                    ArrayList<Integer[]> map = maze.getWalls();
                    ArrayList<Integer[]> path = solver.getPointPath();
